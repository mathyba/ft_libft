...
/*
** Allocates new binary tree node and content, copies size bytes of content
** pointed to by pointer in parameters, adds in corect tree location according
** to sorting conditions set by function pointed to by f.
*/
