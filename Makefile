...
SRCS_CHARS = 
SRCS_CONV = ft_atoi.c ft_atoi_index.c ft_itoa.c ft_itoa_mod.c ft_uitoa.c ft_lltoa.c

SRCS_LISTS = ft_ilstadd.c ft_ilstnew.c ft_slstadd.c ft_slstnew.c ft_lstadd.c ft_lstaddend.c ft_lstdel.c ft_lstdelone.c ft_lstget_last.c ft_lstiter.c ft_lstmap.c ft_lstnew.c ft_lstnewf.c ft_treeadd.c ft_newnode.c ft_destroy_tree.c ft_treedo_order.c
...
SRCS_STR = ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isgraph.c ft_islower.c ft_isprint.c ft_ispunct.c ft_isspace.c ft_isupper.c ft_isxdigit.c ft_tolower.c ft_toupper.c \
get_next_line.c ft_strcat.c ft_strccat.c ft_strchr.c ft_strchri.c ft_strcjoin.c ft_strclr.c ft_strcmp.c ft_strcpy.c ft_strcstr.c ft_strdel.c ft_strdup.c ft_strdupf.c ft_strequ.c ft_striter.c ft_striteri.c ft_strjoin.c ft_strjoinf.c ft_strlcat.c ft_strlen.c ft_strmap.c ft_strmapi.c ft_strnbc.c ft_strnbci.c ft_strncat.c ft_strnccat.c ft_strncmp.c ft_strncpy.c ft_strndup.c ft_strnequ.c ft_strnew.c ft_strnstr.c ft_strrchr.c ft_strrep.c ft_strsplit.c ft_strstr.c ft_strsub.c ft_strsubf.c ft_strtrim.c
