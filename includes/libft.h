...
/*   Updated: 2018/11/26 17:14:12 by emuckens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct	s_lbtree
{
	void			*content;
	struct s_lbtree	*left;
	struct s_lbtree	*right;
}				t_lbtree;
...
void			ft_treeadd(t_lbtree **tree, void *content, int size,
				int (*f)(void *c1, void *c2));
...
char			*ft_strdupf(char *dest, char *str, int to_free);
